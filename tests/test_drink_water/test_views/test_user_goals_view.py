...
class TestUserGoalsView:
    ...
    def test_valid_data_user_goal_view(self, mock_use_case_execute, fixture_user_model, fixture_user_goal_entity_not_completed):
    ...
    @patch.object(UserGoalsUseCase, "execute")
    def test_valid_data_completed_goal_user_goal_view(self, mock_use_case_execute, fixture_user_model, fixture_user_goal_entity_completed):
